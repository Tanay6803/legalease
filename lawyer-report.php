...
<body>
    ...
    <div class="container-fluid py-5" style="background-color: #f8f9fa;">
        <div class="container py-5">
            <h1 class="text-center mb-4">Lawyer Report</h1>
        ...
        <div class="container-fluid py-5">
            <div class="container py-5">
                <div class="table-responsive">
                    <h1 class="text-center mb-4" style="background-color: rgb(47,49,52); color: #FDFAF0;">Lawyer Report
                    </h1>
                    <table class="table table-bordered">
                        ...
                        <?php
                            if($_SERVER['REQUEST_METHOD']=='POST')
                            {
                                if($from="")
                                {
                                    $sql="SELECT * FROM `lawyer` WHERE `state` LIKE '$state'";
                                }
                                else{
                                    if($to="")
                                    {
                                        $to=date('Y-m-d');
                                        $sql="SELECT * FROM `lawyer` WHERE `state` LIKE '$state' AND `dob` BETWEEN '$from' and '$to'";
                                    }
                                    else{
                                        $sql="SELECT * FROM `lawyer` WHERE `state` LIKE '$state' AND `dob` BETWEEN '$from' and '$to'";
                                    }
