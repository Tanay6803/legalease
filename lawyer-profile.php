...
if($_SERVER['REQUEST_METHOD']=='POST')
{
    ...
    $sql="UPDATE `lawyer` SET `fname`='$fname',`lname`='$lname',`email`='$newemail',`password`='$newpassword' WHERE `email`='$email'";
                                        ...
                                        <div class="rounded p-0 my-0" style="background: rgba(55, 55, 63, .7);">
                                            ...
                                            <form id="editProfile">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" name="email" value="<?php echo $row['email']; ?>" />
                                                </div>
                                                <!-- <div class="form-group">
