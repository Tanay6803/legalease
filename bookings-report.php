...
<body>
    ...
    <div class="container-fluid py-5" style="background-color: #f8f9fa;">
        <div class="container py-5">
            <h1 class="text-center mb-4">Booking Report</h1>
            <form action="bookings-report.php" method="post">
                <div class="form-row">
                    <div class="form-group col-md-4">
                        <label for="joinDate">Date of Meeting From</label>
        ...
        <div class="container-fluid py-5">
            <div class="container py-5">
                <div class="table-responsive">
                    <h1 class="text-center mb-4" style="background-color: rgb(47,49,52); color: #FDFAF0;">Booking Report
                    </h1>
                        ...
                        <?php
                            if($_SERVER['REQUEST_METHOD']=='POST')
                            {
                                if($from="")
                                {
                                    ...
                                    {
                                        $to=date('Y-m-d');
                                        $sql="SELECT * FROM `booking_table` WHERE `dateofmeeting` BETWEEN '$from' and '$to'";
                                    }
                                    else{
                                        $sql="SELECT * FROM `booking_table` WHERE `dateofmeeting` BETWEEN '$from' and '$to'";
                                    }
