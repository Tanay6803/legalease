...
if($_SERVER['REQUEST_METHOD']=='POST')
{
  ...
  if(mysqli_num_rows($result)>0)
  {
    ...
    $password=$row['password'];
        ...
        $message="The password of your LegalEase user account is  : <br><h6>".$password."</h6><br> Please don't share this with anyone.";
        $message2="The password of your LegalEase user account is  : ".$password.". Please don't share this with anyone.";
        ...
        $mail->Username = 'legalease.info1@gmail.com';                 // SMTP username
        $mail->Password = 'yjjpqpzgmnmenjky';                           // SMTP password
        $mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
        $mail->Port = 587;                                    // TCP port to connect to

        $mail->setFrom('legalease.info1@gmail.com', 'LegalEase');
